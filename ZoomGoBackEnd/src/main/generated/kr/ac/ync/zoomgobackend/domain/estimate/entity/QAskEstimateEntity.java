...
public class QAskEstimateEntity extends EntityPathBase<AskEstimateEntity> {
    ...
    public final kr.ac.ync.zoomgobackend.domain.category.entity.QCategoryEntity categoryEntity;
    ...
    public QAskEstimateEntity(Class<? extends AskEstimateEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.categoryEntity = inits.isInitialized("categoryEntity") ? new kr.ac.ync.zoomgobackend.domain.category.entity.QCategoryEntity(forProperty("categoryEntity")) : null;
