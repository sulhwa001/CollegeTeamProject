...
//    BoardDTO get(Long id);
    ...
    // DTO -> Entity 변환
    default BoardEntity dtoToEntity(BoardDTO dto, MemberEntity member, ZCategoryRepository categoryRepository) {
        ...
        ZCategoryEntity categoryEntity = categoryRepository.findAll().stream()
