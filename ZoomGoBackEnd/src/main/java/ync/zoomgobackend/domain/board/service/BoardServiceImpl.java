...
public class BoardServiceImpl implements BoardService {
    ...
    private final ZCategoryRepository zcategoryRepository;
    ...
    public void update(Long postId, BoardDTO dto) {
        ...
        if (dto.getCategory() != null && dto.getCategory().getCategoryName() != null) {
            ...
            // 카테고리 이름으로 중복 확인
            ZCategoryEntity category = zcategoryRepository.findAll().stream()
            ...
            // 카테고리 ID로 조회
            ZCategoryEntity category = zcategoryRepository.findById(dto.getCategory().getCategoryId())
