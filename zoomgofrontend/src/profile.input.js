                ...
                <div className="profile_section1">
                    <div className="profiles">
                        <div className="name_picture">
                            ...
                            <div className="gosuInfo">
                                <span className="gosu_name">조은준</span><br />
                                <span className="gosu_review_score">리뷰 평점 0&emsp;&emsp;</span>
                    ...
                    <div className="gosu_profile_detail">
                        ...
                        <div className="gosu_input">
                            <input type="text" name="gosu_name" className="gosu_active_name" placeholder="활동명" />
                        </div>
                        ...
                        <div className="area_insert">
                            <input type="text" name="update" className="gosu_active_area_name" placeholder='광주광역시 북구 중흥동' />
                        </div>
                        ...
                        <div className="gosu_price">
                            ...
                            <label className="price_label">
                                가격 공개&nbsp;</label><input type="checkbox" value="시간" />
                            &nbsp;<button>수정</button>
                        </div>
                        <div className='input_category'>
                            <input type="text" name="price" className="price" placeholder='가격을 입력해주세요.' />
                        </div>

                        <div className="gosu_price">
                            <h3>경력</h3>
                            <button className="gosu_price_update">수정</button>
                        </div>
                        <div className='input_category'>
                            <input type="text" name="price" className="price" placeholder='경력을 입력해주세요.' />
                        </div>
                        ...
                        <div className="portfolio_move">
                            ...
                            <div className="portfolio_explain_move">
                                ...
                                <h3 className="detail_explain">작업 사진과 과정을 포함한 포트폴리오를<br />
